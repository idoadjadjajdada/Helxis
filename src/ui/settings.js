...
export const SETTING_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'differentiate', label: 'Differentiation', type: 'range', min: 0, max: 2, step: 0.1, value: 1, world: true, format: (v) => (v === 0 ? 'off' : `${v.toFixed(1)}×`), note: 'How fast denser material sinks through molten rock. This is why an impactor\u2019s core joins the target\u2019s instead of coating it.' },
      ...
      { id: 'grainBudgetMaxMs', label: 'Collision time budget', type: 'range', min: 11, max: 200, step: 5, value: 70, world: true, format: (v) => `${v} ms/frame`, note: 'What the clock may spend on a collision in flight. Higher pushes through an impact faster, at the cost of frame rate.' },
