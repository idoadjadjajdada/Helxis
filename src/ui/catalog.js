...
export const CATALOG = [
  ...
  {
    id: 'tethys', name: 'Tethys', category: 'moon', kind: 'moon',
    mass: 6.174e20, radius: 5.311e5, temperature: 86, period: 1.888 * DAY,
    composition: { ice: 0.94, silicate: 0.06 },
    crust: { ice: 0.96, regolith: 0.04 },
    note: 'Density 0.98 — very nearly pure water ice, and it would float.',
  },
  {
    id: 'dione', name: 'Dione', category: 'moon', kind: 'moon',
    mass: 1.0954e21, radius: 5.614e5, temperature: 87, period: 2.737 * DAY,
    composition: { ice: 0.55, silicate: 0.45 },
    crust: { ice: 0.88, regolith: 0.12 },
    note: 'Ice cliffs hundreds of metres high, mistaken for wisps until Cassini.',
  },
  {
    id: 'rhea', name: 'Rhea', category: 'moon', kind: 'moon',
    mass: 2.3065e21, radius: 7.638e5, temperature: 76, period: 4.518 * DAY,
    composition: { ice: 0.75, silicate: 0.25 },
    crust: { ice: 0.95, regolith: 0.05 },
    note: 'Saturn\u2019s second largest, and almost entirely frozen water.',
  },
  {
    id: 'ariel', name: 'Ariel', category: 'moon', kind: 'moon',
    mass: 1.251e21, radius: 5.789e5, temperature: 60, period: 2.520 * DAY,
    composition: { ice: 0.45, silicate: 0.55 },
    crust: { ice: 0.86, regolith: 0.14 },
    note: 'The brightest of Uranus\u2019s moons, and the most recently resurfaced.',
  },
  {
    id: 'umbriel', name: 'Umbriel', category: 'moon', kind: 'moon',
    mass: 1.275e21, radius: 5.847e5, temperature: 61, period: 4.144 * DAY,
    composition: { ice: 0.50, silicate: 0.50 },
    crust: { ice: 0.55, carbon: 0.35, regolith: 0.10 },
    note: 'The darkest of them, with one bright ring of frost nobody has explained.',
  },
  {
    id: 'titania', name: 'Titania', category: 'moon', kind: 'moon',
    mass: 3.400e21, radius: 7.887e5, temperature: 60, period: 8.706 * DAY,
    composition: { ice: 0.45, silicate: 0.55 },
    crust: { ice: 0.80, carbon: 0.12, regolith: 0.08 },
    note: 'Uranus\u2019s largest, cut by canyons a thousand kilometres long.',
  },
  {
    id: 'oberon', name: 'Oberon', category: 'moon', kind: 'moon',
    mass: 3.076e21, radius: 7.614e5, temperature: 61, period: 13.463 * DAY,
    composition: { ice: 0.45, silicate: 0.55 },
    crust: { ice: 0.72, carbon: 0.20, regolith: 0.08 },
    note: 'Craters with dark floors, where something welled up after the impact.',
  },
  {
